...
-- Karl Fogel, https://producingoss.com/en/contracting.html#community-review-acceptance[Producing Open Source Software]

[sidebar.measure, id="{sect}.{counter:measure:A}"]
.Ensure the authorship of each contribution (code, documentation or messages) is individual
--
[.tags]
* Adaptation
* Plugin
...
Don't hide the team's contributions under a corporate identity in our own projects or external projects.
In other words, use the usernames and individual email addresses of each participant for the commits in the repository, as well as when participating in the project communication channels or management tools.
...
// M_706::
[sidebar.measure, id="{sect}.{counter:measure:A}"]
.Inform the technical communities of the component to be modified about our plans
--
[.tags]
* Adaptation
...
.Inform other relevant technical communities of our plans
--
[.tags]
* Adaptation
* Plugin
...
// [[M_34D]]
[sidebar.measure, id="{sect}.{counter:measure:A}"]
.Hire developers who are recognised in the project we want to modify
--
[.tags]
* Procurement
* Adaptation
...
.Compel the contract winner to take measures that make it easier to integrate the changes in the original product
--
[.tags]
* Procurement
* Adaptation
...
// M_D19::
[sidebar.measure, id="{sect}.{counter:measure:A}"]
.Penalise contractors if there are any changes in the project staff
--
[.tags]
* Procurement
* Adaptation
...
// M_83F::
[sidebar.measure, id="{sect}.{counter:measure:A}"]
.Budget for the extra costs of participating in the community of the product to be modified
--
[.tags]
* Procurement
* Adaptation
...
// R_29C::
[sidebar.recommendation, id="{sect}.{counter:measure:A}"]
.Maintain a permanent private communication channel for discussing conflicts of interest
--
[.tags]
* Adaptation
* Plugin
...
// M_F2E::
[sidebar.measure, id="{sect}.{counter:measure:A}"]
.Recognise people who make contributions to the project
--
[.tags]
* Plugin
* NewProduct

All individuals that have made a relevant contribution to the code or the documentation should appear in a `CONTRIBUTORS` file in the repository’s root directory.
--

// R_3F3::
[sidebar.recommendation, id="{sect}.{counter:measure:A}"]
.Budget for the extra cost of encouraging the creation of a free software community
--
[.tags]
* NewProduct
...
// M_654::
[sidebar.measure, id="{sect}.{counter:measure:A}"]
.Draw up and update an internal document establishing the level of commitment we want from each party
--
[.tags]
* NewProduct
...
// R_39A::
[sidebar.recommendation, id="{sect}.{counter:measure:A}"]
.In the contract, stipulate that the awardee has to include external contributions if the City Council so decides
--
[.tags]
* Procurement
* Plugin
...
They must be drawn up in English and either be a GitHub/Gitlab wiki page or a text file with light markup language.
...
In many cases the only thing that needs to be said about the third point is that while the contract is in force, the City Council will prioritise the features to be developed and the bugs to be sorted out.
...
// R_0BD::
[sidebar.recommendation, id="{sect}.{counter:measure:A}"]
.Publish detailed Developer Guidelines (if the project grows)
--
[.tags]
* Plugin
* NewProduct
...
// R_5F4::
[sidebar.recommendation, id="{sect}.{counter:measure:A}"]
.Draw up a governance model for the global community that supports the product
--
[.tags]
* NewProduct
* Publication
...
// M_305::
[sidebar.measure, id="{sect}.{counter:measure:A}"]
.Establish the “Contributor Covenant” as the Code of Conduct for the project and its communication channels
--
[.tags]
* Plugin
* NewProduct
...
// M_D61::
[sidebar.measure, id="{sect}.{counter:measure:A}"]
.Do not allow any insults or personal attacks in the communication channels
--
[.tags]
* Plugin
* NewProduct
...
At http://producingoss.com/en/setting-tone.html#prevent-rudeness there is some information on how to 
