...
. To help staff of the http://ajuntament.barcelona.cat/imi/en[Municipal Institute of Information Technology (IMI)], the ICT body of the Barcelona City Council, use technologies based on free software so they make the most of its advantages and minimise potential risks.
