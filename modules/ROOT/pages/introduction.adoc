...
* xref:{lang}/tech-practices:ROOT:aim-and-scope.adoc[Technology Code of Practice]
* xref:{lang}/tech-sovereignty:ROOT:introduction.adoc[Guide to Technological Sovereignty]
* xref:{lang}/ict-procurement:ROOT:context.adoc[Guide to Public ICT Procurement]
...
-- Richard Stallman, https://www.gnu.org/philosophy/government-free-software.en.html[Measures Governments Can Use to Promote Free Software]
