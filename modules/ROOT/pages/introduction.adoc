...
Both the GNU document above and the https://ajuntament.barcelona.cat/digital/en/blog/barcelona-digital-government-open-agile-and-participatory[Release note of the Government Measure: Free software and agile development of public administration services] envision other secondary benefits:
...
* Freeing IT policy and planning from commercial strategies, constructing better tailored, more flexible, more sustainable solutions.
