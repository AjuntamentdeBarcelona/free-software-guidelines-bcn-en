...
The only two things that are not possible to do without being the legal owner of the code is relicense it or transfer the ownership.
...
// (A_C87)
[sidebar.alternative, id="{sect}.{counter:measure:A}"]
.Establish the supplier as the owner of the new source code and the new documentation
--
[.tags]
* Procurement
* Plugin
...
// (M_CAF)
[sidebar.measure, id="{sect}.{counter:measure:A}"]
.Choose the AGPL-3.0 licence as the licence for distributing the project
--
[.tags]
* NewProduct
* Publication
...
// (A-038)
[sidebar.alternative, id="{sect}.{counter:measure:A}"]
.Choose the EUPL-1.2 licence as the licence for distributing the project
--
[.tags]
* NewProduct
* Publication
...
// (M_B12)
[sidebar.measure, id="{sect}.{counter:measure:A}"]
.Choose a licence commonly used in the ecosystem or technological platform of the component to be developed
--
[.tags]
* Procurement
* Plugin
