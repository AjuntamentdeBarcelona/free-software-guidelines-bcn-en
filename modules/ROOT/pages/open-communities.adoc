...
There are many levels of participation in a FLOSS project, and none of them should be closed.
...
It is the only model which FLOSS projects are structurally equipped to handle.
...
As it is an free software component, they cannot prevent us from making modifications.
...
Measure: Penalise contractors if there are any changes in the project staff M_D19::
  ...
  +
  A high turnover is detrimental to any project but especially when participating in FLOSS projects.
...
Recommendation: Maintain a permanent private communication channel for discussing conflicts of interest R_29C::
  ...
  +
  When people are hired to take part in an established FLOSS project, especially if they are developers that were already taking part in it, there could be a conflict of interest between the City Council project and the original source project.
...
But it needs to be borne in mind that open, public communication channels are essential to FLOSS projects, so everyone can read them and subscribe to them with a certain ease.
...
Measure: Establish the “Contributor Covenant” as the Code of Conduct for the project and its communication channels M_305::
  ...
  +
  A code of conduct serves as a written reference for behaviour that is considered inappropriate for people taking part in the project, More specifically, the https://www.contributor-covenant.org/ has been used by many FLOSS projects lately, so it may be familiar to lots of developers already.
