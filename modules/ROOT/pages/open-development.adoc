...
== Procurement for community development

[[M_F60]]

Measure: Award the contract to companies with experience in community development M_F60::
...
The _reservoirs of distributed knowledge_ are one of the main strengths of free software projects.
  +
  It also helps a great deal to ensure community development processes are established from the outset.
