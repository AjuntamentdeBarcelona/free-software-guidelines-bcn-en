...
// M_BD2::
[sidebar.measure, id="{sect}.{counter:measure:A}"]
.Integrate external contributions into the main repository by means of the Pull Request mechanism
--
[.tags]
* Plugin
* NewProduct
...
// M_488::
[sidebar.measure, id="{sect}.{counter:measure:A}"]
.Don’t upload binary files or build process files (with exceptions)
--
[.tags]
* Integration
* Adaptation
...
// M_CC8::
[sidebar.measure, id="{sect}.{counter:measure:A}"]
.Don’t upload sensitive information regarding users, the City Council or third parties to the repository
--
[.tags]
* Procurement
* Integration
...
// M_35A
[sidebar.measure, id="{sect}.{counter:measure:A}"]
.[.line-through]#Link the main repository to the GitHub issue manager#
--
[.tags]
* Day1
* Adaptation
